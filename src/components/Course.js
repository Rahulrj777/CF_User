            ...
            <Slider {...settings} className="">
                ...
                <div className=" px-2 w-[30%] h-[30rem] m-2 group  bg-white/10  flex flex-col items-center justify-center gap-2 relative overflow-hidden cursor-pointer transition-all duration-300 ease-in shadow-lg ">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-500 ease-in-out transform -translate-x-full group-hover:translate-x-0 z-20">
                        ...
                        <p className=" text-gray-900 tracking-wider text-[12px] font-roboto px-4 text-justify">This one-year film course blends theory and practicals, covering filmmaking basics, story development, direction, industry immersion, practical filming, and concludes with a web series project and comprehensive exams for industry readiness. </p>

                        <div>
                            <Link to='/direction' onClick={topPage}>
                                <button className="mt-4 bg-[#ff0000] hover:bg-transparent hover:border-2 hover:border-[#ff0000] hover:text-[#ff0000]  text-white rounded-md shadow-md cursor-pointer text-[14px] md:text-[16px] py-2.5 px-6 text-sm font-semibold ">Explore More</button>
                            </Link>
                        </div>
                    </div>
                ...
                <div className="px-2 w-[30%] h-[30rem] m-2 group  bg-white/10  flex flex-col items-center justify-center gap-2 relative overflow-hidden cursor-pointer transition-all duration-300 ease-in shadow-lg ">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-500 ease-in-out transform -translate-x-full group-hover:translate-x-0 z-20">
                        ...
                        <p className=" text-gray-900 tracking-wider text-[12px] font-roboto px-4 text-justify">This one-year program covers about the history of cinema, photography, advanced cinematography, and post-production, culminating industry visits and web series production for comprehensive theoretical and practical experience.</p>
                        <div>
                ...
                <div className="px-2 w-[30%] h-[30rem] m-2 group  bg-white/10  flex flex-col items-center justify-center gap-2 relative overflow-hidden cursor-pointer transition-all duration-300 ease-in shadow-lg ">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-500 ease-in-out transform -translate-x-full group-hover:translate-x-0 z-20">
                        ...
                        <p className="text-gray-900 tracking-wider text-[12px] font-roboto px-4 text-justify">This one-year editing course covers Avid Media Composer, Final Cut Pro, and DaVinci Resolve, progressing from film editing theory to advanced techniques, AI tools, and practical projects, including editing a web series, for comprehensive training.</p>
                        <div>
                ...
                <div className="px-2 w-[30%] h-[30rem] m-2 group  bg-white/10  flex flex-col items-center justify-center gap-2 relative overflow-hidden cursor-pointer transition-all duration-300 ease-in shadow-lg ">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-500 ease-in-out transform -translate-x-full group-hover:translate-x-0 z-20">
                        ...
                        <p className="text-gray-900 tracking-wider text-[12px] font-roboto px-4 text-justify"> This 12-week program covers photography fundamentals, advanced techniques, and film appreciation, culminating in a final project and exhibition, with a certificate upon completion. </p>
                        <div>
                ...
                <div className="px-2 w-[30%] h-[30rem] m-2 group  bg-white/10  flex flex-col items-center justify-center gap-2 relative overflow-hidden cursor-pointer transition-all duration-300 ease-in shadow-lg">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-500 ease-in-out transform -translate-x-full group-hover:translate-x-0 z-20">
                        ...
                        <p className="text-gray-900 tracking-wider text-[12px] font-roboto px-4 text-justify">This three-month course covers digital imaging, color correction, advanced color grading, VFX integration, and culminates in a final 5-minute film project, with additional classes on film direction, cinematography, and editing.</p>
                        <div>
