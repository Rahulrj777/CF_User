                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-x-3 md:gap-x-16   gap-y-8 md:gap-y-14 mt-1  font-kumbh">
                        <div>
                          <div className="flex flex-col  items-center gap-y-3">
                            <div>
                              <img
                                src={iconone}
                                className=" w-14 md:w-20 object-cover mb-2"
                                alt="icon"
                                title="VFX training courses"
                                loading="lazy"
                                fetchpriority="low"
                              />
                            </div>
                            ...
                            <div className="flex flex-col items-center ">
                              <h3 className="uppercase font-semibold text-center  text-[10px] md:text-[14px] text-gray-700 tracking-[1px]">
                                Updated Ai{" "}
                              </h3>
                              <h3 className="uppercase font-semibold text-center  text-[10px] md:text-[14px] text-gray-700 tracking-[1px]">
                                Integrated Modules{" "}
                        ...
                        <div>
                          <div className="flex flex-col  items-center gap-y-3">
                            ...
                            <div>
                              <h3 className="uppercase font-semibold text-center  text-[10px] md:text-[14px] text-gray-700 tracking-[1px]">
                                Student Discounts on Softwares & Equipments
                              </h3>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="flex flex-col  items-center gap-y-3">
                            <div>
                              <img
                                ...
                                className=" w-14 md:w-20 object-cover mb-2"
                                alt="icon"
                                title="Best Courses in Direction"
                                loading="lazy"
                                fetchpriority="low"
                              />
                            </div>
                          ...
                          <div className="flex flex-col  items-center gap-y-3">
                            <div>
                              <img
                                ...
                                className=" w-14 md:w-20 object-cover mb-2"
                                alt="icon"
                                title="Best Cinema Factory Acadmey"
                                loading="lazy"
                                fetchpriority="low"
                              />
                            </div>
                          ...
                          <div className="flex flex-col  items-center gap-y-3">
                            <div>
                              <img
                                ...
                                className=" w-14  md:w-20 object-cover mb-2"
                                alt="icon"
                                title="Top Courses in Direction"
                                loading="lazy"
                                fetchpriority="low"
                              />
                            </div>
                          ...
                          <div className="flex flex-col  items-center gap-y-3">
                            <div>
                              <img
                                ...
                                className=" w-14 md:w-20 object-cover mb-2"
                                alt="icon"
                                title="Chennai Filmmaking Academy In India"
                                loading="lazy"
                                fetchpriority="low"
                              />
                            </div>
                          ...
                          <div className="flex flex-col  items-center gap-y-3">
                            <div>
                              <img
                                ...
                                className=" w-14 md:w-20 object-cover mb-2"
                                alt="icon"
                                title="Top-Rated VFX Training Institute In India"
                                loading="lazy"
                                fetchpriority="low"
                              />
                            </div>
                          ...
                          <div className="flex flex-col  items-center gap-y-3">
                            <div>
                              <img
                                ...
                                className=" w-14 md:w-20 object-cover mb-2"
                                alt="icons"
                                title="Learn Photography Courses In India"
                                loading="lazy"
                                fetchpriority="low"
                              />
                            </div>
