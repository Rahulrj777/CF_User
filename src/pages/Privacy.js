          ...
          <div className="mt-8 flex flex-col  gap-y-4 md:gap-y-6 px-1 md:px-5">
            <div className="flex flex-col gap-y-3 ">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                Welcome to Cinema Factory Academy. This Privacy Policy explains
                how we collect, use, disclose, and protect your information when
                you visit our website, enroll in our courses, or use our
                services.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-y-3 ">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                Personal Information: When you register on our site, subscribe
                to our newsletter, enroll in courses, or interact with us in
                other ways, we may collect personal information, including but
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                ...
                information such as your browser type, operating system, IP
                address, and browsing behavior on our website.{" "}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-y-3 ">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                To Provide Services: We use your information to process your
                enrollment, provide course materials, facilitate payment, and
                offer customer support.
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                Communication: We may use your information to send you
                newsletters, promotional materials, updates about our courses,
                and other information that may interest you. You can opt-out of
                these communications at any time.
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                Improvement of Services: We use the information to understand
                how our services are used, to improve our website and course
                offerings, and to develop new services and features.
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                Compliance and Protection: We may use your information to comply
                with legal obligations, resolve disputes, enforce our terms of
                service, and protect the rights, property, or safety of Cinema
                Factory Academy, our users, and others.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-y-3 ">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                ...
                required by law or in response to lawful requests from
                government authorities or other public entities.{" "}
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                Business Transfers: In the event of a merger, acquisition,
                reorganization, or sale of our assets, your information may be
            ...
            <div className="flex flex-col gap-y-3 ">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                ...
                from us by following the unsubscribe instructions included in
                those communications or by contacting us.{" "}
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                Data Deletion: You can request the deletion of your personal
                information by contacting us. We will take reasonable steps to
                delete your information, except where we are required to retain
            ...
            <div className="flex flex-col gap-y-3 ">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                ...
                personal information from a child under 13, we will delete such
            ...
            <div className="flex flex-col gap-y-3 ">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                ...
                periodically for any changes. Your continued use of our website
