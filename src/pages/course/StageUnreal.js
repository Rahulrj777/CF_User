            ...
            <div className="w-full px-4 md:w-[80%] mx-auto">
              ...
              <div className="flex flex-col gap-y-2 justify-center items-center mb-6 md:mb-12">
                ...
                <p className="text-center w-full md:w-[70%] text-gray-200 text-[12px] md:text-[14px]">
                  This 3-month program blends intensive hands-on training with
                  industry-based techniques, giving you a strong foundation in
                  creative color workflows and real-world projects.
                </p>
              </div>
