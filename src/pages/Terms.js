      ...
      <section className="bg-gray-50 flex px-3 py-3 md:p-8 font-[roboto]">
        ...
        <div className="w-full  md:w-[85%] bg-white p-4 rounded-md border-2 border-gray-100 drop-shadow-md shadow-lg mx-auto">
          <div className="my-1 sm:my-2 md:my-3">
            <h3 className="text-gray-900 font-bold uppercase text-center font-[poppins] text-[14px] sm:text-[16px] md:text-[22px]">
              terms & conditions
            </h3>
          </div>
          ...
          <div className="mt-8 flex flex-col  gap-y-4 md:gap-y-6 px-1 md:px-5">
            <div className="flex flex-col gap-y-3 ">
              <p className="font-bold text-[14px] sm:text-[16px] md:text-[20px] text-gray-600 ">
                Introduction
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] ">
                Welcome to Cinema Factory Academy. These Terms and Conditions
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                ...
                website and services. By using our website, you represent and
                warrant that you meet this age requirement.
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                Account Registration: To access certain features of our website,
                you may need to register for an account. You agree to provide
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                ...
                unlawful purpose or in any way that could harm, disable,
                overburden, or impair the website. You also agree not to use any
                automated means to access the website, including robots,
                spiders, or similar tools.
              </p>
            </div>

            <div className="flex flex-col gap-y-3">
              <p className="font-bold text-[14px] sm:text-[16px] md:text-[20px] text-gray-600">
                3. Course Enrollment and Payments
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                Enrollment: By enrolling in a course, you agree to pay the
                applicable fees and to comply with any additional terms and
                conditions that may apply to the course.{" "}
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                Payments: All payments must be made through our authorized
                payment methods. You agree to provide accurate and complete
                payment information and to keep your payment information up to
                date.
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                Refunds: Our refund policy is detailed on our website. Please
                review it carefully before enrolling in a course.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                ...
                logos, images, and software, is the property of Cinema Factory
                Academy or its licensors and is protected by copyright,
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                ...
                website for your personal, non-commercial use. You may not
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                No Warranty: Our website and services are provided on an "as is"
                and "as available" basis without any warranties of any kind,
                either express or implied. Cinema Factory Academy disclaims all
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                ...
                Cinema Factory Academy shall not be liable for any indirect,
                ...
                use the website; (b) any unauthorized access to or use of our
                ...
                (e) any errors or omissions in any content; and/or (f) any other
                matters relating to the website, whether based on warranty,
                contract, tort, or any other legal theory, and whether or not
                Cinema Factory Academy has been advised of the possibility of
                such damages.{" "}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                You agree to indemnify, defend, and hold harmless Cinema Factory
                Academy, its affiliates, and their respective officers,
                directors, employees, agents, licensors, and suppliers from and
                against any claims, actions, demands, liabilities, and
                settlements, including, without limitation, reasonable legal and
                accounting fees, arising out of or resulting from your violation
                of these Terms or your use of the website, including, but not
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                ...
                of any changes by posting the new Terms on our website. You are
                advised to review these Terms periodically for any changes. Your
                continued use of our website and services after the posting of
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                These Terms and your use of our website shall be governed by and
                construed in accordance with the laws of the jurisdiction in
                which Cinema Factory Academy operates, without regard to its
            ...
            <div className="flex flex-col gap-y-2">
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px] font-medium">
                {" "}
                BigBay Cinema Factory Private Limited
              </p>
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
              ...
              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                Thank you for using Cinema Factory Academy. We hope you enjoy
                your experience with us.
              </p>

              <p className="text-gray-600 text-[11px] sm:text-[12px] md:text-[14px]">
                This website is operated by BigBay Cinema Factory
              </p>
            </div>
          </div>
        </div>
